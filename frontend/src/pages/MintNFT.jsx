...
import { generateMetadata, uploadMetadata, uploadImage } from '../services/metadata';
...
const MintNFT = () => {
  ...
  const handleMint = async (e) => {
    ...
    try {
      ...
      let imageUrl = 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&q=80';
      ...
      const carbonData = {
        ...
        vintageYear: parseInt(projectDetails.vintageYear) || new Date().getFullYear(),
          ...
          {!wallet.connected && (
            <div className="mb-8 bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-yellow-300 text-sm">Please connect your Solana wallet to mint Carbon Credit NFTs</p>
              </div>
            </div>
          )}
                    ...
                    <div className="bg-gradient-to-br from-gray-700/50 to-gray-800/50 rounded-2xl p-6 mb-6 border border-gray-600/50">
                      <div className="relative aspect-square bg-gray-600 rounded-xl mb-4 overflow-hidden group">
                        <img 
                          ...
                          onError={(e) => {
                            console.error('❌ Failed to load image:', mintedNFT.image);
                            e.target.src = 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&q=80';
                          }}
                          onLoad={() => {
                            console.log('✅ Image loaded successfully:', mintedNFT.image);
                          }}
                        />
